        ...
        <Container 
            ...
            <Box sx={{
                ...
                <Typography 
                    ...
                    Es ideal para aprender con contenido de calidad y comunicar en italiano de manera rápida y natural.
                </Typography>
                <Box 
                    sx={{
                        display:'flex',
            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Typography variant='h6'>
                        ¡Accedé al CURSO COMPLETO por sólo €{elemento.precioEuros} (euros)
                    </Typography>
                    <Typography variant='h6'>
                        PROMOCIÓN ESPECIAL PARA ARGENTIN@S: AR${elemento.precio}!
                    </Typography>
